...
inline int ignite_adamw_param_groups_size (void* groups) {
  auto ret =  _ignite_adamw_param_groups_size(groups);
  host_exception_handler();
  return ret;
}
inline void* ignite_optim_get_param_group_params (void* groups, int i) {
  auto ret =  _ignite_optim_get_param_group_params(groups, i);
  host_exception_handler();
  return ret;
}
inline adamw_options ignite_adamw_get_param_group_options (void* groups, int i) {
  auto ret =  _ignite_adamw_get_param_group_options(groups, i);
  host_exception_handler();
  return ret;
}
inline void ignite_adamw_set_param_group_options (void* opt, int i, adamw_options options) {
...
inline void ignite_adamw_set_states (void* opt, void* states) {
   _ignite_adamw_set_states(opt, states);
  host_exception_handler();
